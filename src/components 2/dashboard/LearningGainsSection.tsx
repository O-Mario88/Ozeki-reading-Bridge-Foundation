            ...
            {domain.atBenchmarkPct !== null && (
                <div style={{ marginTop: "0.75rem" }}>
                    ...
                    <div style={{ display: "flex", borderRadius: "6px", overflow: "hidden", height: "14px", fontSize: "0.65rem", fontWeight: 600 }}>
                        ...
                        <div
                            style={{ width: `${domain.atBenchmarkPct}%`, background: "#FFF4EC", color: "#FA7D15", display: "flex", alignItems: "center", justifyContent: "center", minWidth: (domain.atBenchmarkPct ?? 0) > 8 ? undefined : 0 }}
        ...
        <section id="learning-gains-section" style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                {data.schoolImprovementIndex !== null && (
                    <div style={{
                        background: data.schoolImprovementIndex > 0 ? "#FFF4EC" : "#fee2e2",
                        color: data.schoolImprovementIndex > 0 ? "#FA7D15" : "#dc2626",
