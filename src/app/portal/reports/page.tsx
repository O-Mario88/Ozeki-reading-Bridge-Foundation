      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6 space-y-5 max-w-[1600px] mx-auto">
        ...
        <section className="rounded-2xl bg-white border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="hidden lg:block px-3 pb-1">
            <DashboardListHeader template="minmax(0,2fr) minmax(0,1.2fr) minmax(0,1fr) 170px 90px 110px 90px">
              <span>Report Name</span>
              <span>Category</span>
              <span>Generated By</span>
            ...
            {RECENT_REPORTS.map((r, i) => (
              <DashboardListRow
                key={`d-${i}`}
                template="minmax(0,2fr) minmax(0,1.2fr) minmax(0,1fr) 170px 90px 110px 90px"
              >
                <span className="text-[13px] text-gray-900 font-semibold truncate">{r.name}</span>
                <span className="text-[13px] text-gray-700 truncate">{r.category}</span>
                <span className="text-[13px] text-gray-700 truncate">{r.generatedBy}</span>
                <span className="text-[12px] text-gray-500 whitespace-nowrap">{r.date}</span>
