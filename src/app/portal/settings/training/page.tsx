        ...
        <div className="max-w-4xl mx-auto p-6 lg:p-10 bg-white min-h-screen">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 flex justify-end">
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="inline-flex items-center px-6 py-2.5 border border-transparent text-sm font-bold rounded-lg shadow-sm text-white bg-[#ff7235] hover:bg-[#D96A0F] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ff7235] disabled:opacity-50 transition-colors"
                >
                    {saving ? (
