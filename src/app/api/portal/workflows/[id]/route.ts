...
export async function GET(_request: Request, { params }: RouteContext) {
  try {
    ...
    logger.error("[portal/workflows/:id] GET unavailable", { error: error instanceof Error ? error.message : String(error) });
...
export async function PATCH(request: Request, { params }: RouteContext) {
  try {
    ...
    logger.error("[portal/workflows/:id] PATCH update failed", { error: error instanceof Error ? error.message : String(error) });
