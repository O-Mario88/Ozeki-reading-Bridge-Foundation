...
function priorityBadge(flag: "urgent" | "watch" | "on-track") {
    const styles: Record<string, { bg: string; color: string; label: string }> = {
        ...
        "on-track": { bg: "#FFF0E8", color: "#FF4D00", label: "✓ On track" },
    };
            ...
            >
                <div className="container" style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1rem" }}>
                        ...
                        <article className="card impact-kpi-card" style={{ borderLeft: "4px solid #FF4D00" }}>
                                        ...
                                        >
                                            ...
                                            <td style={{ padding: "0.5rem", textAlign: "right" }}>
                                                {row.outcomesScore !== null ? (
                                                    <span style={{ color: row.outcomesScore > 0 ? "#FF4D00" : "#dc2626", fontWeight: 600 }}>
