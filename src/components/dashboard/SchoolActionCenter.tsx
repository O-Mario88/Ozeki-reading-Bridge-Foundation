...
function GapTag({ domain, change }: { domain: string; change: number | null }) {
    ...
    const color = change > 0 ? "#FA7D15" : change < -5 ? "#dc2626" : "#b45309";
    return (
        <span style={{
        ...
        <section id="school-action-center" style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem" }}>
                ...
                <ActionCard title="Implementation Fidelity" accent={
                    data.fidelity.band === "Strong" ? "#FA7D15" :
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                        <div style={{
                            ...
                            color: data.fidelity.band === "Strong" ? "#FA7D15" :
            ...
            {data.gains.schoolImprovementIndex !== null && (
                <div style={{
                    ...
                    borderRadius: "12px",
                    background: data.gains.schoolImprovementIndex > 0 ? "#FFF4EC" : "#fee2e2",
                    color: data.gains.schoolImprovementIndex > 0 ? "#FA7D15" : "#dc2626",
                    fontWeight: 700,
                }}>
