        ...
        <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
                ...
                <div style={{
                    ...
                    color: score >= 70 ? "#FF4D00" : score >= 40 ? "#e8a317" : "#dc2626",
                }}>
                    {score}%
                </div>
            </div>
                ...
                {COACHING_CHECKLIST.map((item) => (
                    <label
                        ...
                        style={{
                            ...
                            background: checked.has(item.id) ? "#FFF0E820" : "transparent",
                    ...
                    >
                        <input
                            ...
                            style={{ marginTop: "0.15rem", accentColor: "#FF4D00", width: 16, height: 16 }}
                        />
                        <div>
