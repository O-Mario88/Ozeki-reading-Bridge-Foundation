...
function normalizeSchoolRecord(row: Record<string, unknown>): SchoolDirectoryRecord {
  ...
  return {
    ...
    schoolRelationshipStatus: asNullableString(row.schoolRelationshipStatus),
    schoolRelationshipStatusDate: asNullableString(row.schoolRelationshipStatusDate),
    denomination: asNullableString(row.denomination),
    protestantDenomination: asNullableString(row.protestantDenomination),
    clientSchoolNumber: Number(row.clientSchoolNumber ?? 0),
    firstMetricDate: asNullableString(row.firstMetricDate),
    metricCount: Number(row.metricCount ?? 0),
    runningTotalMaxEnrollment: Number(row.runningTotalMaxEnrollment ?? 0),
    partnerType: asNullableString(row.partnerType),
    ...
    gpsLat: asNullableString(row.gpsLat),
    gpsLng: asNullableString(row.gpsLng),
