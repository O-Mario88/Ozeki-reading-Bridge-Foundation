  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: "trainingPresenter", label: "Training Presenter", type: "text" },
        ...
        {
          key: "facilitatedByContactId",
          label: "Facilitated by",
          type: "select",
          options: [], // Injected dynamically from finance contacts
        },
      ],
    },
  ],
