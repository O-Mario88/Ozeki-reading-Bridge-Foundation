-- Phase 5: FinTech & Services schema.
-- Ports the 15-table payment/service delivery schema from the legacy
-- /api/migrate/services runtime route into the deterministic migration chain.
-- The portal finance dashboard and Pesapal payment routes query these tables
-- directly; without them, /portal/finance throws and renders the error boundary
...
-- 7. service_payments  (source of the /portal/finance dashboard crash)
